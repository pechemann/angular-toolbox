...
import { AtxDefaultLogConnector, AtxLogBuilder, AtxLogLevel } from "projects/angular-toolbox/src/public-api";
...
describe('AtxConsoleLogConnector', () => {
    ...
    let connector: AtxDefaultLogConnector = new AtxDefaultLogConnector();
    ...
    it('sendLog() should do nothing if a log is specified with AtxLogLevel.LOG', () => {
        spyOn(console, "log");
        spyOn(console, "warn");
        spyOn(console, "error");
    ...
    it('sendLog() should do nothing if a log is specified with AtxLogLevel.WARNING', () => {
        spyOn(console, "log");
        spyOn(console, "warn");
        spyOn(console, "error");
    ...
    it('sendLog() should do nothing if a log is specified with AtxLogLevel.ERROR', () => {
        spyOn(console, "log");
        spyOn(console, "warn");
        spyOn(console, "error");
